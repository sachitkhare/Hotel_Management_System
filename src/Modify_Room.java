...
public class Modify_Room   extends JFrame implements ActionListener{
        ...
        if(e.getSource()==b1)
        {
           try {
        	   ...
        	   String number=t1.getText();
				...
				String ta=(String)t4.getSelectedItem();
				String type=(String)t5.getSelectedItem();
				
				c.s.executeUpdate("update room set availability='"+ava+"' ,price='"+price+"',status='"+ta+"', bed_type='"+type+"' where roomnumber ="+number);
         	   JOptionPane.showMessageDialog(null, "Room Sucessfully Modify ");
 	            setVisible(false);
       		}
